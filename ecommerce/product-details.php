...
// $productObject = new User;
// $userObject->setId($_GET['id']);
// $result = $userObject->getUserById();
// if($result->num_rows == 1){
                ...
                <div class="product-details-content">
                    ...
                    <div class="pro-dec-categories">
                        <ul>
                            ...
                            <li><a
                                    href="shop.php?category=<?= $product->category_id ?>"><?=  $product->catigory_name ?>,</a>
                            </li>
                            <li><a
                                    href="shop.php?subcategory=<?= $product->subcategory_id ?>"><?=  $product->subcatigory_name ?>,</a>
                            </li>
