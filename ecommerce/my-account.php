...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    //             if ($_SESSION['user']->image != 'defalt.jpg') {
    ...
    if (isset($_POST['pass_update'])) {
        ...
        if (empty($validation->getErrors())) {
            $user = new User;
            $user->setFirst_name($_POST['password']);
            if ($user->updatePassword()) {
                $_SESSION['user']->password = $_POST['password'];
                $success2 = "<div class='alert alert-success text-center'> Password Updated Successfully </div>";
            } else {
                $error2 = "<div class='alert alert-danger text-center'> Something went wrong </div>";
            }
        }
    }
}
                                                ...
                                                <div class="col-lg-12 col-md-12">
                                                    <div class="billing-info">
                                                        <select name="gender" class="form-control" id="">
                                                            <option <?= $_SESSION['user']->gender == 'm' ? 'selected' : '' ?> value="1">Male</option>
                                                            <option <?= $_SESSION['user']->gender == 'f' ? 'selected' : '' ?> value="0">Female</option>
                                                        </select>
                                ...
                                <form method="post">
                                    <div class="billing-information-wrapper">
                                        ...
                                        <div class="billing-back-btn">
                                            ...
                                            <div class="billing-btn">
                                                <button type="submit" name="pass_update">Continue</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
