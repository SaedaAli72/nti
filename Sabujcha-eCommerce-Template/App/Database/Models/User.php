...
class User extends Model{
    private $id,$first_name,$last_name,$email,$password,$phone,$gender,$status,$verification_code,$image,$email_verified_at,$created_at,$updated_at;
...
public function create()
{
    ...
    ,$this->phone,$this->gender,$this->verification_code);
    return $stmt->execute();
}
...
public function updateDate()
{
    ...
    $stmt->bind_param('ss', $this->email,$this->email_verified_at);
     $stmt->execute();
