...
class Product extends Model{
    private $id,$name_en,$name_ar,$details_en,$details_at,$price,$code,$quantity,$status,$image,$subcatigory_id,$brand_id,$created_at,$updated_at;
    ...
    /**
     * Get the value of details_at
     */ 
    public function getDetails_at()
    {
        return $this->details_at;
    }

    /**
     * Set the value of details_at
     *
     * @return  self
     */ 
    public function setDetails_at($details_at)
    {
        $this->details_at = $details_at;
