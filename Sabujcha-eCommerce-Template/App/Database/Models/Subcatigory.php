...
{
    private $id,$name_en,$name_ar,$status,$image,$catigory_id,$created_at,$updated_at;
    ...
    public function get()
    {
        $query="SELECT id,name_en FROM subcatigories WHERE status = " . self::Active;
    ...
    public function getsubcatigoriesbycatigory()
    {
        $query="SELECT id,name_en FROM subcatigories WHERE status = " . self::Active . " AND catigory_id = ?";
        $stmt =$this->connect->prepare($query);
