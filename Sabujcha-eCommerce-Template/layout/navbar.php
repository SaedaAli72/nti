<?php
    ...
    use App\Database\Models\Catigory;
use App\Database\Models\Subcatigory;

    $Catigory = new Catigory;
    $Catigoriesdata = $Catigory->get()->fetch_all(MYSQLI_ASSOC);
    // print_r($Catigoriesdata);
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                        <ul class="mega-menu">
                                            <?php foreach($Catigoriesdata as $catigory) {
                                                $Subcatigory->setCatigory_id($catigory['id']);
                                                $Subcatigorydata = $Subcatigory->getsubcatigoriesbycatigory()->fetch_all(MYSQLI_ASSOC);
                                                ?>
                                            <li>
                                                <ul>
                                                <li ><a class="font-weight-bold mb-3" href="shop.php?catigory=<?= $catigory['id']?>"><?= $catigory['name_en']?></a></li>
                                                    <?php foreach($Subcatigorydata as $subcatigory) {?>

                                                    <li><a href="shop.php?subcatigory=<?= $subcatigory['id']?>"><?= $subcatigory['name_en']?></a></li>
                                                    <?php } ?>
