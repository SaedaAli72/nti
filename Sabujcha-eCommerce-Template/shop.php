...
if($_GET){
    if(isset($_GET['subcatigory'])){
        $products->setSubcatigory_id($_GET['subcatigory']);
        $productsdata = $Products->getproductsIncatigory()->fetch_all(MYSQLI_ASSOC);
    }elseif(isset($_GET['catigory'])){
        $products->setCatigory_id($_GET['catigory']);
        $productsdata = $Products->getproductsInCatigory()->fetch_all(MYSQLI_ASSOC);
    }
}else{
    $productsdata = $Products->get()->fetch_all(MYSQLI_ASSOC);
                                        ...
                                        <div class="product-wrapper">
                                            <div class="product-img">
                                                <a href="product-details.php?id=<?= $products['id']?>">
                                                    <img alt="" src="assets/img/product/<?= $products['image']?>">
                                                </a>
                                            ...
                                            <div class="product-content text-left">
												<div class="product-hover-style">
													<div class="product-title">
														<h4>
															<a href="product-details.php?id=<?= $products['id']?>"><?= $products['name_en']?></a>
														</h4>
													</div>
													<div class="cart-hover">
														<h4><a href="product-details.php?id=<?= $products['id']?>">+ Add to cart</a></h4>
													</div>
												</div>
                                            ...
                                            <div class="product-list-details">
                                                ...
                                                <div class="product-price-wrapper">
                                                    <span class="product-price-old"><?= $products['price']?></span>
                                                </div>
                                                <p><?= $products['details_en']?></p>
